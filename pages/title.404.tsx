...
export default function Title404() {
    return (
        <Head>
            ...
            <title>404 - Page Not Found | Square Space</title>
            ...
            <meta name="keywords" content="404, Page Not Found, Square Space, Portfolio,broken link ,missing page,link not found" />
